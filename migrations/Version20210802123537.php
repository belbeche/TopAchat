 ...
 */
final class Version20210802123537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, datetime DATETIME NOT NULL, price INT NOT NULL, date_fin_garantie DATETIME NOT NULL, commentaires LONGTEXT NOT NULL, manuel TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
